...
const SignUpPage = () => {
	...
	return (
		<div className='flex flex-col justify-center py-12 sm:px-6 lg:px-8'>
			...
			>
				<div className='bg-[#8B4513] py-8 px-4 shadow sm:rounded-lg sm:px-10'>
					<form onSubmit={handleSubmit} className='space-y-6'>
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								...
								<input
									...
									className='block w-full px-3 py-2 pl-10 bg-white border border-gray-600 rounded-md shadow-sm
									 placeholder-gray-700 focus:outline-none focus:ring-black  focus:border-black sm:text-sm'
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								...
								<input
									...
									rounded-md shadow-sm
									 placeholder-gray-400 focus:outline-none focus:ring-black
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								...
								<input
									...
									className=' block w-full px-3 py-2 pl-10 bg-white border
									 border-gray-600 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-black focus:border-black sm:text-sm'
									placeholder='••••••••'
								/>
							</div>
						</div>
						...
						<button
							...
							rounded-md shadow-sm text-sm font-medium text-white bg-black
							  ...
							  hover:bg-white hover:text-black focus:outline-none focus:ring-2 focus:ring-offset-2
