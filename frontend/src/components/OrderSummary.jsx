...
const stripePromise = loadStripe(
  "pk_test_51QgumyFCJDCoudZ5ZLhALCdAYq4pL9HO7H02V5DgkZQReetk9ZKkipkhGbbrSLHY8sKU4BGbZOUWtZ9aJwHeHe1K00NK3ZB3wk"
);
...
const OrderSummary = () => {
  ...
  const handlePayment = async (e) => {
    ...
    try {
      ...
      const res = await axiosInstance.post("/payments/esewa-init", {
        amount: total,
        name: user?.name,
        email: user?.email,
      });
